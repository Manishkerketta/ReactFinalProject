...
const LoginPage = () => {
  ...
  return (
    // Outer Container: 1440px wide canvas logic (min-h-screen for height)
    <div className="min-h-screen w-full bg-[#FBFBFB] flex items-center justify-center font-sans overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {/* LOGIN CARD: Width 475px, Height 521px */}
        <div className="w-[475px] h-[521px] bg-white rounded-[10px] shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 flex flex-col items-center p-10">
          ...
          {/* Heading: 395x60 */}
          <div className="w-[395px] h-[60px] flex items-center justify-center mb-6">
            <h2 className="text-[24px] font-bold text-[#1A1A1A]">Login to your Account</h2>
          </div>

          <form className="w-full flex flex-col items-center">
            
            {/* Input Group (Username & Password): 395x160 */}
            <div className="w-[395px] h-[160px] flex flex-col justify-between mb-8">
              {/* Username */}
            ...
            {/* Action Group (Login Button to Forgot Password): 395x77 */}
            <div className="w-[395px] h-[77px] flex flex-col justify-between">
              <button 
                type="submit"
                className="w-full h-[48px] bg-[#8B0000] hover:bg-[#700000] text-white font-bold rounded-md transition-all text-[16px]"
              >
                Login
              </button>
        ...
        {/* FOOTER: Fixed positioning or relative to card */}
        <div className="mt-10 flex gap-8 text-[12px] text-gray-400">
